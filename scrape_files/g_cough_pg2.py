...
# -*- coding:utf-8 -*-
my_url = 'https://www.guardian.com.sg/health/pl/Cough%2C%20Cold%20%26%20Allergy?q=%3Arelevance&page=1&pageSize=0&source=productList&text=&sort=&mydisplayValue=&title=&fromPage='
...
f = open('g_cough_pg2.csv','w', encoding="utf-8")
